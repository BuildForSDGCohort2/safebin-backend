...
<head>
    ...
    <title>SafeBin Admin | Check Prize Application</title>
...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Prize Applications</li>
                </ol>
            </section>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    $stmt = $DB_con->prepare("SELECT * from prize WHERE status='0'");
                                    $stmt->execute();
    ...
    function admit(id){
		  ...
		  $('#btn_accept'+id).load("functions/acceptprize.php", {
			  like_id:id 
		  }
		  )
	  ...
	  function reject(id){
		  //alert(id);
		  document.getElementById("btn_accept"+id).disabled = true;
		  $('#btn_reject'+id).load("functions/rejectprize.php", {
			  like_id:id 
		  }
		  )
		  document.getElementById("btn_reject"+id).disabled = true;
