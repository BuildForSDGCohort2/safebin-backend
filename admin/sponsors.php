...
<head>
    ...
    <title>SafeBin Admin | Check Sponsors</title>
...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Check Sponsors</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">View Sponsors</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    $stmt = $DB_con->prepare("SELECT * from sponsor");
                                    $stmt->execute();
    ...
    <script>
	  function del(id){
		  //alert(id);
		  $('#btn_del'+id).load("functions/del_sponsor.php", {
			  like_id:id 
		  }
		  )
