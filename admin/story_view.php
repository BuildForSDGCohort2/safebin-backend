...
<head>
    ...
    <title>SafeBin Admin | Check Success Story</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    SafeBin  Users
                    <small>| Check Success Story</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">Check Success Story</li>
                </ol>
            </section>

            <?php
                require_once "../required/dbconfig.php";
                $stmt = $DB_con->prepare("SELECT * from story WHERE id='$get_id'");
                $stmt->execute();
            ...
            <div class="row">
                ...
                <ul class="timeline">
                    ...
                    <div class="timeline-item">
                        ...
                        <h3 class="timeline-header"><a href="#">Success Story</a></h3>
